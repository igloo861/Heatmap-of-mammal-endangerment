...
<div style="margin-bottom: 10px;">
    <div style="margin-bottom: 20px;">
        This is a map showing endangered mammals according to the <b>IUCN Red List</b>. 
        IUCN is a global organization that consolidates red lists from different countries into one category. 
        It categorizes species into categories ranging from "Least Concern" to "Extinct" (see image above).
    </div>
</div>
...
<div style="margin-bottom: 20px; font-size: 10px; color: gray;">
    This map is not endorsed nor connected to the IUCN and data may be old. To see the up-to-date data see <a href="https://www.iucnredlist.org">IUCN homepage</a>. 
</div>
